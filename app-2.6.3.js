(() => {
"use strict";
const VERSION="2.6.3",KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
function ballVisual25(step){
  ...
  if(actorP&&a.type==="set"&&a.technique==="upper")return{x:actorP.x,y:actorP.y-178*actorP.scale,scale:actorP.scale};
