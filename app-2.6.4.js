(() => {
"use strict";
const VERSION="2.6.4",KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
function ballVisual25(step){
  ...
  if(actorP&&a.type==="set"&&a.technique==="upper")return{x:actorP.x,y:actorP.y-206*actorP.scale,scale:actorP.scale};
