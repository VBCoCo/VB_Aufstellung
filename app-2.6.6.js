(() => {
"use strict";
const VERSION="2.6.6",KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
function contactHeight25(step){
  ...
  if(supportsTechnique(a.type)){
    if(a.technique==="upper")return a.type==="set"?188:170;
...
function ballVisual25(step){
  ...
  if(actorP&&a.type==="set"&&a.technique==="upper")return{x:actorP.x,y:actorP.y-156*actorP.scale,scale:actorP.scale};
