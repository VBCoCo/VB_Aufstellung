(() => {
"use strict";
const VERSION="2.7.0",DATA_SCHEMA=5,KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
e.teamConfigToggle?.addEventListener("click",()=>{if(!editing)return;teamConfigOpen=!teamConfigOpen;e.teamConfigPanel?.classList.toggle("hidden",!teamConfigOpen);buildLineupEditor();});
