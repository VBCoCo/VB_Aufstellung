(() => {
"use strict";
const VERSION="2.8.1",DATA_SCHEMA=6,KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
let editing=false,selected=null,dragging=null,playing=false,animations=[],editorPassword=null,lineupOpen=false,teamConfigOpen=false,situationConfigOpen=false,committedState=structuredClone(state),dirty=false,namingNewStep=false,actionMenuOpen=false;
