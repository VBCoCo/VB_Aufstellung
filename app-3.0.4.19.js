(() => {
"use strict";
const VERSION="3.0.4.19",DATA_SCHEMA=8,KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
function render25(){
  ...
  e.view2d.classList.toggle("active",preferredView==="2d");e.view25d.classList.toggle("active",preferredView==="25d");if(e.positionInfoToggle){e.positionInfoToggle.classList.toggle("active",showPositionInfo);e.positionInfoToggle.textContent=`# ${showPositionInfo?"an":"aus"}`;e.positionInfoToggle.setAttribute("aria-pressed",String(showPositionInfo))}
  if(!visible)return;
