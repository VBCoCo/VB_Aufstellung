(() => {
"use strict";
const VERSION="2.5.5",KEY="volleyball-trainer-v2-2",TEST_PASSWORD="";
...
function contactHeight25(step){
  ...
  if(supportsTechnique(a.type)){
    if(a.technique==="upper")return 86;
