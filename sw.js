...
const AI_MODEL_CACHE = "vb-ai-melody-v1";
...
const ELLEN_VOICE_ASSETS = ["one","two","three","four","five","action","pause","change","next-station","serve","reception","set-break","block-break","block","warm-up","warm-up-easy","increase-tempo","preparation","power","start","stop","continue","training-complete","and","work"].map(name => `./assets/audio/voice-de-ellen/${name}.mp3`);
const APP_SHELL = ["./index.html",`./style.css?v=${CORE_VERSION}`,`./vendor/tone-15.1.22.js?v=${CORE_VERSION}`,`./music-library.js?v=${CORE_VERSION}`,`./training-player.js?v=${VERSION}`,`./training-music-phase.js?v=${VERSION}`,`./training-audio-diagnostics.js?v=${VERSION}`,`./training-audio-diagnostics-panel.js?v=${VERSION}`,`./app.js?v=${VERSION}`,`./config.js?v=${VERSION}`,`./exercise-library.css?v=${VERSION}`,`./exercise-library.js?v=${VERSION}`,`./feature-admin.js?v=${VERSION}`,`./project-memory.js?v=${VERSION}`,`./ui-3.14.4.css?v=${VERSION}`,`./ui-3.14.12.css?v=${VERSION}`,`./ui-3.14.13.css?v=${VERSION}`,`./ui-3.14.14.css?v=${VERSION}`,`./ui-3.14.15.css?v=${VERSION}`,`./ui-3.14.16.css?v=${VERSION}`,`./ui-3.14.17.css?v=${VERSION}`,`./ui-3.14.18.css?v=${VERSION}`,`./ui-3.14.19.css?v=${VERSION}`,`./ui-3.14.20.css?v=${VERSION}`,`./ui-3.14.21.css?v=${VERSION}`,`./ui-3.14.22.css?v=${VERSION}`,`./ui-3.14.23.css?v=${VERSION}`,`./ui-3.14.24.css?v=${VERSION}`,`./ui-3.14.25.css?v=${VERSION}`,`./ui-3.14.26.css?v=${VERSION}`,`./ui-3.14.27.css?v=${VERSION}`,`./ui-3.14.28.css?v=${VERSION}`,`./ui-3.14.29.css?v=${VERSION}`,`./ui-3.14.34.css?v=${VERSION}`,`./manifest.webmanifest?v=${CORE_VERSION}`,`./assets/ttc-logo.png?v=${CORE_VERSION}`,`./assets/apple-touch-icon.png?v=${CORE_VERSION}`,`./assets/icon-192.png?v=${CORE_VERSION}`,`./assets/icon-512.png?v=${CORE_VERSION}`,"./assets/audio/kick.wav","./assets/audio/snare.wav","./assets/audio/hat-closed.wav","./assets/audio/hat-open.wav","./assets/audio/bass-c2.wav","./assets/audio/bass-c3.wav","./assets/audio/LICENSE.md","./assets/audio/voice-de-kerstin/LICENSE.md","./assets/audio/voice-de-thorsten/LICENSE.md","./assets/audio/voice-custom-b/README.md","./assets/audio/voice-custom-c/README.md","./assets/audio/voice-de-ellen/README.md","./assets/music/ronald-kah/LICENSE.md",...VOICE_ASSETS,...CUSTOM_VOICE_ASSETS,...ELLEN_VOICE_ASSETS];
APP_SHELL.push(
  `./style.css?v=${VERSION}`,
